...
| `windows.nsis.installMode: "perUser"` | Прав адміністратора немає. Викладач на доменній машині академії майже напевно не локальний адмін; `perMachine` зробив би застосунок невстановлюваним. Наслідок: ставиться у `%LOCALAPPDATA%\Programs\Asistent`. |
